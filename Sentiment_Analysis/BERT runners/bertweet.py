...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        ...
        BTC_OUTPUT_DIR = r"Sentiment_Analysis\BERT runners\sentiment_bertweet\bitcoin" 
        ETH_INPUT_DIR  = r"Sentiment_Analysis\google scraping\cleaned data\ethereum_cleaned"
        ETH_OUTPUT_DIR = r"Sentiment_Analysis\BERT runners\sentiment_bertweet\ethereum" 
