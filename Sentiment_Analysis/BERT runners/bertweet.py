"""
bertweet_scoring_corrected.py
-------------------------------------------
Batch‑score Google‑SERP (or any) news/title+snippet data with bertweet.
Fixes & enhancements compared with the original script:
  ...
  • *max_length* increased from 128 –> 256 (bertweet was trained at 256).
  • Quick CLI with sensible defaults, so you can run:
        python bertweet_scoring_corrected.py --input IN_DIR --output OUT_DIR
...
def _cli():
    p = argparse.ArgumentParser(description="Batch‑score JSON SERP data with bertweet")
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        ...
        BTC_OUTPUT_DIR = r"C:\Users\user\Desktop\Uni_work\year_3\Sem_2\DIA\project code\sentiment_data\google_search_data\sentiment_bertweet\bitcoin" 
        ...
        ETH_OUTPUT_DIR = r"C:\Users\user\Desktop\Uni_work\year_3\Sem_2\DIA\project code\sentiment_data\google_search_data\sentiment_bertweet\ethereum" 
