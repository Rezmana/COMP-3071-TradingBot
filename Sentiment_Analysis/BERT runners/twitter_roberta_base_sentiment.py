"""
RoBERTa_scoring_corrected.py
-------------------------------------------
Batch‑score Google‑SERP (or any) news/title+snippet data with RoBERTa.
Fixes & enhancements compared with the original script:
  ...
  • *max_length* increased from 128 –> 256 (RoBERTa was trained at 256).
  • Quick CLI with sensible defaults, so you can run:
        python RoBERTa_scoring_corrected.py --input IN_DIR --output OUT_DIR
...
def _cli():
    p = argparse.ArgumentParser(description="Batch‑score JSON SERP data with RoBERTa")
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        ...
        BTC_OUTPUT_DIR = r"C:\Users\user\Desktop\Uni_work\year_3\Sem_2\DIA\project code\sentiment_data\google_search_data\sentiment_roberta\bitcoin" 
        ...
        ETH_OUTPUT_DIR = r"C:\Users\user\Desktop\Uni_work\year_3\Sem_2\DIA\project code\sentiment_data\google_search_data\sentiment_roberta\ethereum" 
