...
model = load_model(
r"trading_agent\model\Bit_Coin_Price_Prediction_LSTM_Model_4chain.keras"
)
scaler_X = joblib.load(
r"trading_agent\scalers\btc_scaler_X_4ChainMetrics.pkl"
)
scaler_y = joblib.load(
r"trading_agent\scalers\btc_scaler_y_4ChainMetrics.pkl"
)
